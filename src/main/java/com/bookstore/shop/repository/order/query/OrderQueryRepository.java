...
public class OrderQueryRepository {
    ...
    private List<OrderItemQueryDto> findOrderItems(Long orderId) {
        return em.createQuery(
                "select new com.bookstore.shop.dto.OrderItemQueryDto(oi.order.id, i.name, oi.orderPrice, oi.count)"+
                        "from OrderItem oi"+
                        " join oi.item i"+
    ...
    public List<OrderQueryDto> findOrders(){
        return em.createQuery("select new com.bookstore.shop.dto.OrderQueryDto(o.id, m.name,o.orderDate, o.status, d.address)"+
                " from Order o"+
                " join o.member m"+
    ...
    public List<OrderQueryDto> findOrderAllByDto() {
        List<OrderQueryDto> result = findOrders();
